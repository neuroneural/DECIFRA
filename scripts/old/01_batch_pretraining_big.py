...
if __name__ == "__main__":
    ...
    model_cfg.rnn.input_embedding_size = 64
    model_cfg.rnn.hidden_size = 64
    model_cfg.btp.hidden_dim = 64
    ...
    save_path = f"1_pretrain_{model.__class__.__name__}_big/{idx:02d}"
